...
Fluência é uma aplicação web desenvolvida como TCC (Trabalho de Conclusão de Curso) que auxilia crianças no desenvolvimento da fluência de leitura. O projeto combina testes interativos, análise de desempenho e recursos administrativos para acompanhamento de progresso.

**Autor:** Felipe Silva Mantuani
**Versão:** 1.0.0
...
- 📊 **Dashboard de Desempenho** - Visualização de progresso e histórico
...
- Abra uma [Issue](https://github.com/Lipezl/Fluence-TCC/issues)
...
**Desenvolvido por:** Felipe Silva Mantuani  
...
Feito com ❤️ para melhorar a fluência de leitura das crianças
